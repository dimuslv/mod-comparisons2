class com.nitrome.toxic.BasicBomb extends MovieClip
{
   var anim;
   var game;
   var vx;
   ...
   {
      return com.nitrome.toxic.Global.BOMB_BASIC;
   }
   ...
   function doExplode()
   {
      this.game.createExplosion(this._x,this._y,this._name,com.nitrome.toxic.Global.BOMB_BASIC);
   }
   ...
   function checkConveyorWalls(v)
   {
      ...
      if(v != 0)
      {
         if(v > 0)
         {
            _loc4_ = new Array(-8,-6,-4,-2,0,2,4,6);
